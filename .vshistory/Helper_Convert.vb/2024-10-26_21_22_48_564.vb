...
Public Class Helper_Convert
    Public Shared Function ConvertToDouble(ByVal var_Object As Object, ByVal Optional DefaultValue As Double = 0, ByVal Optional Culture As CultureInfo = Nothing) As Double
        ...
        Try
            ...
            Else
                ...
                End If
                If (Double.TryParse(Convert.ToString(var_Object).Trim, System.Globalization.NumberStyles.Float, Culture, retVal)) Then
                    Return retVal
                Else
                    retVal = DefaultValue
                End If
        ...
        Catch ex As Exception
            TimeShare_Error.ErrorHandling.HandleErrorCatch(ex, Error_Helper.GetCallingProc(), System.Reflection.MethodBase.GetCurrentMethod().Name, Environment.CurrentManagedThreadId, False, False)
    ...
    Public Shared Function ConvertToInteger(ByVal var_Object As Object, ByVal Optional DefaultValue As Integer = 0) As Integer
        ...
        Try
            ...
            ElseIf Not Integer.TryParse(Convert.ToString(var_Object).Trim, retVal) Then
                Return retVal
            Else
                Return retVal
            End If
    ...
    Public Shared Function ConvertToSingle(ByVal var_Object As Object, ByVal Optional DefaultValue As Single = 0) As Single
        ...
        Try
            If Not Single.TryParse(Convert.ToString(var_Object).Trim, retVal) Then
                retVal = DefaultValue
            End If
    ...
    Public Shared Function ConvertToShort(ByVal var_Object As Object, ByVal Optional DefaultValue As Short = 0) As Short
        ...
        Try
            If Not Short.TryParse(Convert.ToString(var_Object).Trim, retVal) Then
                retVal = DefaultValue
            End If
    ...
    Public Shared Function ConvertToUShort(ByVal var_Object As Object, ByVal Optional DefaultValue As UShort = 0) As UShort
        ...
        Try
            If Not UShort.TryParse(Convert.ToString(var_Object).Trim, retVal) Then
                retVal = DefaultValue
            End If
    ...
    Public Shared Function ConvertToLong(ByVal var_Object As Object, ByVal Optional DefaultValue As Long = 0) As Long
        ...
        Try
            If Not Long.TryParse(Convert.ToString(var_Object).Trim, retVal) Then
                retVal = DefaultValue
            End If
    ...
    Public Shared Function ConvertToString(ByVal var_Object As Object, ByVal Optional trimmed As Boolean = False, ByVal Optional DefaultValue As String = "") As String
        ...
        Try
            If var_Object Is Nothing Then
                retVal = DefaultValue
            Else
                retVal = Convert.ToString(var_Object).Trim
            End If
            If trimmed Then
                Return retVal.Trim
            Else
